...
export const LocalSandboxMonitor: React.FC<LocalSandboxMonitorProps> = ({
  ...
  return (
    <div className="p-4 rounded-2xl bg-slate-950 text-slate-100 border border-slate-800/80 shadow-md font-mono text-xs space-y-3">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-800/80 pb-2.5">
        ...
        <div className="flex items-center gap-2 text-[11px] text-emerald-400 bg-emerald-950/60 px-2.5 py-0.5 rounded-full border border-emerald-800/80">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-[11px]">
        ...
        <div className="flex items-center gap-2.5 text-slate-300">
          <ArrowUpRight className="size-4 text-amber-400 shrink-0" />
          <div>
